            ...
            for page in range(1, page_num + 1):
                ...
                if is_empty:
                    for i in range(0, len(info) - 2):
                        ...
                        print
                        u"转发数: " + str(retweet_num)

                        # 评论数
                        comment_num = int(guid[2])
                        self.comment_num.append(comment_num)
                        print
                        u"评论数: " + str(comment_num)
                        print
                        "==========================================================================="
...
def main():
    try:
        ...
        u"用户名: " + wb.username
        print
        u"全部微博数: " + str(wb.weibo_num)
        print
        u"关注数: " + str(wb.following)
        print
        u"粉丝数: " + str(wb.followers)
        if wb.weibo_content:
            print
            u"最新/置顶 微博为: " + wb.weibo_content[0]
            print
            u"最新/置顶 微博位置: " + wb.weibo_place[0]
            print
            u"最新/置顶 微博发布时间: " + wb.publish_time[0]
            print
            u"最新/置顶 微博获得赞数: " + str(wb.up_num[0])
            print
            u"最新/置顶 微博获得转发数: " + str(wb.retweet_num[0])
            print
            u"最新/置顶 微博获得评论数: " + str(wb.comment_num[0])
            print
            u"最新/置顶 微博发布工具: " + wb.publish_tool[0]
    except Exception, e:
        print
        "Error: ", e
        traceback.print_exc()
